...
MYSQL_USER = "ojuser"            # USERNAME to which you have granted the database access.
MYSQL_PASS = "ojadminpass"            # PASSWORD for the abode user.
...
endTime   = "29 Aug 2014 23:00"                   # The time contest ends, evaluation stops and submissions are freezed.
